...
@section simple_diffusion_miniapp Simple Diffusion Miniapp
...
It creates a field, sets all values of the field to random values within a range and diffuses the field.
