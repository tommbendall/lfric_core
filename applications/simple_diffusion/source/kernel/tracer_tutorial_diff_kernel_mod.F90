...
! Copy of tracer_smagorinsky_diff_kernel_mod.F90 from gungho/source/kernel
module tracer_tutorial_diff_kernel_mod
  ...
  type, public, extends(kernel_type) :: tracer_tutorial_diff_kernel_type
    private
  ...
  contains
    procedure, nopass :: tracer_tutorial_diff_code
  end type

  !---------------------------------------------------------------------------
  ! Contained functions/subroutines
  !---------------------------------------------------------------------------
  public :: tracer_tutorial_diff_code
...
end subroutine tracer_tutorial_diff_code

end module tracer_tutorial_diff_kernel_mod
