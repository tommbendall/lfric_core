...
##############################################################################
"""
Turns namelist descriptions into extended namelist specific objects.
"""
...
class NamelistDescription:
    ...
    def get_module_name(self) -> str:
        ...
        """
        return self._listname + "_nml_mod"
    ...
    def write_module(self, file_object: Path) -> None:
        ...
        nml_template = "extended_namelist_type.f90.jinja"
        template = self._engine.get_template(nml_template)
